    ...
    persistState([
      ...
      serialize(data) {
        return JSON.stringify(Object.keys(data)
          .reduce((acc, key) => ({ ...acc, [key]: data[key].toJS() }), {}))
        ;
      },
      deserialize(data) {
