const oscars = {
  categories: {
    ...
    documentaryFeature: {
      ...
      nominees: [
        { text: 'Fire at Sea', secondaryText: 'Gianfranco Rosi and Donatella Palermo' },
        { text: 'I Am Not Your Negro', secondaryText: 'Raoul Peck, Rémi Grellety and Hébert Peck' },
        { text: 'Life, Animated', secondaryText: 'Roger Ross Williams and Julie Goldman' },
        { text: 'O.J.: Made in America', secondaryText: 'Ezra Edelman and Caroline Waterlow' },
        { text: '13th', secondaryText: 'Ava DuVernay, Spencer Averick and Howard Barish' }
      ]
    },
    documentaryShort: {
      value: 2,
    ...
    musicOriginalSong: {
      ...
      nominees: [
        ...
        { text: 'Jim: The James Foley Story', secondaryText: 'The Empty Chair' },
    ...
    writingAdaptedScreenplay: {
      ...
      nominees: [
        ...
        { text: 'Hidden Figures', secondaryText: 'Allison Schroeder and Theodore Melfi' },
    ...
    writingOriginalScreenplay: {
      ...
      nominees: [
        ...
        { text: 'La La Land', secondaryText: 'Damien Chazelle' },
        { text: 'The Lobster', secondaryText: 'Yorgos Lanthimos, Efthimis Filippou' },
        { text: 'Manchester by the Sea', secondaryText: 'Kenneth Lonergan' },
