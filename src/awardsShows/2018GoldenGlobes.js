const goldenGlobes = {
  categories: {
    ...
    bestActorMusicalComedy: {
      value: 8,
      name: 'Best Performance by an Actor in a Motion Picture - Musical or Comedy',
      nominees: [
    ...
    bestActorLimitedTV: {
      value: 8,
      name: 'Best Performance by an Actor in a Limited Series or Motion Picture Made for Television',
      nominees: [
    ...
    bestActressLimitedTV: {
      value: 8,
      name: 'Best Performance by an Actress in a Limited Series or Motion Picture Made for Television',
      nominees: [
    ...
    bestSupportingActorTV: {
      value: 4,
      name: 'Best Performance by an Actor in a Supporting Role in a Series, Limited Series or Motion Picture Made for Television',
      nominees: [
    ...
    bestSupportingActressTV: {
      value: 4,
      name: 'Best Performance by an Actress in a Supporting Role in a Series, Limited Series or Motion Picture Made for Television',
      nominees: [
...
export function saveImages () {
  ...
  database().ref('/titles').once('value', snapshot => {
    ...
    database().ref('/people').orderByChild('name').once('value', snapshot => {
