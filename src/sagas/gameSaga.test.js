...
describe('game saga', () => {
  it('should watch for game create', () => {
    ...
    expect(generator.next().value).toEqual(fork(takeLatest, CREATE_GAME, createGame))
  })
  ...
  it('should create a game', () => {
    ...
    const newGameId = 'abc';
    expect(generator.next(newGameId).value).toEqual(call(API.createGame, newGameId, action.payload))
  })
})
